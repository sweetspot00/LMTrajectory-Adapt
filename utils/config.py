...
def parse_args():
    ...
    parser.add_argument("--homography_dir", type=str, default=None, help="Optional override for homography matrix directory.")
    parser.add_argument("--caption_suffix", type=str, default="_caption.txt", help="Caption filename suffix.")
    parser.add_argument("--strip_scene_tokens", nargs='*', default=None, help="Tokens to strip from scene names when matching assets.")
    parser.add_argument("--reference_image_suffix", type=str, default="_reference.png", help="Reference scene image suffix.")
    parser.add_argument("--oracle_image_suffix", type=str, default="_oracle.png", help="Oracle/segmentation image suffix.")
